 ...
 * @brief Class for the Path Agent
...
namespace walle {
    ...
    /**
     * @brief Constructor (agent default)
    ...
    /**
     * @brief Checks that the agent is able to move arbitrarily.
    ...
    /**
     * @brief Increments the index into the offsets sequence
     */
    ...
    /**
     * @brief Decrements the index into the offsets sequence
     */
    ...
    /**
     * @brief Retrieves the position of the agent after applying the current offset
    ...
    /**
     * @brief Overrides AgentBase GetNextPosition to retrieve the calculated next position
    ...
    /**
     * @brief Assigns the offsets_member to a new series of offsets
    ...
    /**
     * @brief Assigns the offsets_ member to a new series of offsets, taking a command
     * string
    ...
    /**
     * @brief Retrieves which step the agent is on
     * @return the current index into the offsets
     */
    int PathAgent::GetIndex() const { return index_; }

    /**
     * @brief Returns an immutable reference to this agent's current path
