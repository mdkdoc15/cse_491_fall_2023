 ...
 * @brief Class for the Path Agent. Agent to move in predefined path
...
namespace walle {
    ...
    /**
     * @class PathAgent
     * @brief Agent that has a user-defined custom movement pattern.
     * Passed a sequence of to be sequentially applied as the agent is updated
     */
    class PathAgent : public cse491::AgentBase {
    protected:
        /// @brief Collection of ways to offset the Agent's position
